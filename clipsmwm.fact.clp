...
(defrule on-map-request
	...
	(println "x-get-input-focus-> " (x-get-input-focus ?display))
	(x-set-input-focus ?display ?window RevertToParent 0)
	(println "x-get-input-focus-> " (x-get-input-focus ?display))
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-warp-pointer ?display 0 (default-root-window ?display) 0 0 0 0 100 100)
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-sync ?display)
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-warp-pointer ?display 0 (default-root-window ?display) 0 0 0 0 200 200)
	(x-sync ?display)
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-warp-pointer ?display 0 (default-root-window ?display) 0 0 0 0 300 300)
	(x-sync ?display)
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-warp-pointer ?display 0 (default-root-window ?display) 0 0 0 0 400 400)
	(x-sync ?display)
	(println "x-query-pointer-> " (x-query-pointer ?display))
	(x-warp-pointer ?display 0 (default-root-window ?display) 0 0 0 0 500 500)
	(x-sync ?display)
	(println "x-query-pointer-> " (x-query-pointer ?display))
